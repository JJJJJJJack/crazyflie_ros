...
int main(int argc, char **argv)
{
  ...
  n.param("enable_logging_ando", enable_logging_ando, true);
  n.param("enable_logging_angle", enable_logging_angle, true);
  ...
  addCrazyflie.request.enable_logging_ando = enable_logging_ando;
  addCrazyflie.request.enable_logging_angle = enable_logging_angle;	
